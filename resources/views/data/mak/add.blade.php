...
<div class="container-admin">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('simpanDataMAK') }}">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-md-12">  
                                <div class="form-group">
                                    <label for="id_subKegiatan">Kegiatan</label>
                                    <select class="form-control" name="id_subKegiatan" id="id_subKegiatan" required readonly>
                                    @foreach($subKegiatans as $res)
                                        <option value="{{ $res->id }}">{{ $res->kegiatan->kegiatan }}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-12">  
                                <div class="form-group">
                                    <label for="id_subKegiatan">Sub Kegiatan</label>
                                    <select class="form-control" name="id_subKegiatan" id="id_subKegiatan" required readonly>
                                    @foreach($subKegiatans as $res)
                        ...
                        @endif
                            ...
                            <div class="col-12 col-md-12">  
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mak" required name="mak">
                                </div>
                            </div>
                            <div class="col-12 col-md-3">  
                                <div class="form-group">
                                    <label for="nilai">Nilai / Dana (IDR)</label>
                                    <input onkeypress="return isNumberKey(event)" type="text" class="form-control" id="nilai" required name="nilai">
                                </div>
                            </div>
                        </div>
